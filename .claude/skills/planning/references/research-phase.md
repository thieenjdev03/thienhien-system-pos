...
Load: `references/clickup-integration.md`
- Fetch task details with user story documentation
- Extract requirements from ClickUp docs API
- Use when provided with ClickUp task ID (E4G-XXX, ABC-123, etc.)
